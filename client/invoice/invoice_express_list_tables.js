...
Template.invoicelist.onCreated(function () {
  ...
  let headerStructure = [
    ...
    { index: 3, label: "Customer", class: "colCustomer", active: true, display: true, width: "125" },
    { index: 4, label: "Amount (Ex)", class: "colAmountEx", active: true, display: true, width: "125" },
    { index: 5, label: "Tax", class: "colTax", active: true, display: true, width: "70" },
    { index: 6, label: "Amount (Inc)", class: "colAmount", active: true, display: true, width: "125" },
    ...
    // { index: 12, label: "Custom Field 1", class: "colCustomField1", active: false, display: true, width: "280" },
    // { index: 13, label: "Custom Field 2", class: "colCustomField2", active: false, display: true, width: "280" },
    // { index: 14, label: "Custom Field 3", class: "colCustomField3", active: false, display: true, width: "280" },
